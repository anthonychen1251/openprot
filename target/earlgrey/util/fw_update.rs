...
use earlgrey_util::manifest::{Manifest, ManifestExtHeader};
use earlgrey_util::tags::{BootSlot, ManifestExtId, ManifestIdentifier};
...
impl FwUpdate {
    ...
    fn try_read_bundle_at(
        ...
        for entry in &owner_hdr.extensions {
            if entry.identifier == ManifestExtId::OWNER_TRANSFER_BLOB {
